...
public:
   ...
   bool isReturn()    const { return isReturnPress;};
   bool isDelete()    const { return isDeletePress;};
   ...
   bool isG()         const { return isGPress;     };
   bool isH()         const { return isHPress;     };
   bool isI()         const { return isIPress;     };
   bool isJ()         const { return isJPress;     };
   bool isK()         const { return isKPress;     };
   bool isL()         const { return isLPress;     };
   bool isM()         const { return isMPress;     };
   bool isN()         const { return isNPress;     };
   bool isO()         const { return isOPress;     };
   ...
   bool isU()         const { return isUPress;     };
...
private:
   ...
   static bool isReturnPress;
   static bool isDeletePress;
   static bool isPausePress;
   static bool isAPress;
   static bool isBPress;
   static bool isCPress;
   static bool isDPress;
   static bool isEPress;
   static bool isFPress;
   static bool isGPress;
   static bool isHPress;
   static bool isIPress;
   static bool isJPress;
   static bool isKPress;
   static bool isLPress;
   static bool isMPress;
   static bool isNPress;
   static bool isOPress;
   static bool isPPress;
   static bool isQPress;
   static bool isRPress;
   static bool isSPress;
   static bool isTPress;
   static bool isUPress;
   static bool isVPress;
   static bool isWPress;
